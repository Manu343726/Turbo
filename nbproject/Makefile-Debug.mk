...
# CC Compiler Flags
CCFLAGS=-stdlib=libc++ -lc++abi -ftemplate-backtrace-limit=0 -ftemplate-depth=10000000
CXXFLAGS=-stdlib=libc++ -lc++abi -ftemplate-backtrace-limit=0 -ftemplate-depth=10000000
...
${OBJECTDIR}/blocks/manu343726/turbo_main/main.o: blocks/manu343726/turbo_main/main.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iblocks -Iblocks/manu343726 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/blocks/manu343726/turbo_main/main.o blocks/manu343726/turbo_main/main.cpp
